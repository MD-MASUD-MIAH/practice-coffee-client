...
const Addcoffee = () => {
    return (
      ...
      <form className="w-full max-w-4xl bg-[#f4f3f0] p-8 rounded-lg shadow-md grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
        ...
        <div>
          <label className="block mb-2 text-sm font-semibold text-gray-700">Taste</label>
          <input
            name='taste'
            type="text"
        ...
        <div className="md:col-span-2">
          <label className="block mb-2 text-sm font-semibold text-gray-700">Photo</label>
          <input
            name='photo'
            type="text"
