...
console.log(id);
 ...
 Users List
             ...
             <p className='text-[#7D5A50]'>Users List is a section where you can view and manage all registered users of the platform. It displays essential information such as usernames, email addresses, roles,</p> 
...
<table className='table'>
  ...
  <tr>
...

    {
        ...
        users.map((user,index)=><tbody key={user._id} user={user}>  
